  ...
  return (
    <div className="min-h-screen bg-bg-body pt-40 pb-32 px-4 relative overflow-hidden">
      ...
      <div className="container max-w-5xl relative z-10">
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 sm:mb-16 gap-6 sm:gap-8 animate-fade-in border-b border-text-main/10 pb-8">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 animate-fade-in delay-100">
          {/* Reservations Card */}
          <div className="group bg-bg-surface/90 backdrop-blur-md border border-text-main/10 p-8 sm:p-10 hover:border-primary/40 hover:shadow-[0_0_40px_rgba(166,138,86,0.15)] transition-all duration-500 cursor-pointer relative overflow-hidden">
            ...
            <Link to="/reservations" className="block h-full relative z-10">
              ...
              <span className="inline-flex items-center gap-3 text-[10px] uppercase tracking-[3px] text-primary transition-all group-hover:text-text-main">
                Ver Detalles <span className="w-6 h-[1px] bg-primary group-hover:bg-text-main transition-colors"></span>
              </span>
            </Link>
          </div>
        ...
        <div className="mt-16 bg-bg-surface/90 backdrop-blur-md border border-text-main/10 p-8 sm:p-10 relative overflow-hidden animate-fade-in delay-200">
