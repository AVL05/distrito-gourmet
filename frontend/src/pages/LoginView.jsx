...
const LoginView = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh] bg-bg-body relative overflow-hidden py-24">
      ...
      <div className="w-full max-w-lg bg-white/90 backdrop-blur-xl p-12 md:p-16 border border-gray-200 shadow-[0_0_50px_rgba(0,0,0,0.5)] rounded-sm relative z-10">
        {/* Corner accents */}
