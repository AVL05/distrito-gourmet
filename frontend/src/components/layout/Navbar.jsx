...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      {isOpen && (
        <div className="fixed top-0 left-0 w-full h-screen bg-bg-surface flex flex-col items-center justify-center animate-fade-in">
          {/* Líneas decorativas */}
          ...
          <div className="relative z-10 flex flex-col items-center gap-12 text-center w-full max-w-5xl px-4 overflow-y-auto max-h-screen py-20 pb-24 md:py-0">
