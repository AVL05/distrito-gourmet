...
- **Mejoras PFC/demo entregadas:** disponibilidad pública de turnos, métricas de administración, revalidación de carrito y contacto validado desde API.
- **Pasarela de Pagos Real:** Integración con **Stripe** o **PayPal** para el cobro automático de pedidos takeaway y la gestión de "fianzas" en las reservas de mesas para evitar el _no-show_.
...
- **Aplicación Móvil Nativa:** Desarrollo de una App en **React Native** o **Flutter** utilizando la misma API REST actual, permitiendo una experiencia de reserva más integrada y el uso de notificaciones push.
